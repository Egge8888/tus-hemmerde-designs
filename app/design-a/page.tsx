...
// Red: #dc2626  Darker red: #991b1b  Bright red: #ef4444
// White accents, dark slate background
  ...
  return (
    <div style={{ backgroundColor: "#0f172a", color: "#fff", fontFamily: "'Arial Black', 'Impact', system-ui, sans-serif", minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", minHeight: "92vh", display: "flex", alignItems: "center", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: "20%", left: "10%", width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(220,38,38,0.14) 0%, transparent 70%)", pointerEvents: "none" }}></div>
        <div style={{ position: "absolute", bottom: "10%", right: "5%", width: 600, height: 600, borderRadius: "50%", background: "radial-gradient(circle, rgba(220,38,38,0.06) 0%, transparent 70%)", pointerEvents: "none" }}></div>
        <div style={{ position: "absolute", inset: 0, backgroundImage: "linear-gradient(rgba(220,38,38,0.025) 1px, transparent 1px), linear-gradient(90deg, rgba(220,38,38,0.025) 1px, transparent 1px)", backgroundSize: "60px 60px", pointerEvents: "none" }}></div>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "80px 24px", position: "relative", zIndex: 10 }}>
          ...
          <h1 style={{ fontSize: "clamp(3rem, 8vw, 6.5rem)", fontWeight: 900, lineHeight: 0.95, letterSpacing: "-0.04em", marginBottom: 32, textTransform: "uppercase" }}>
            DEIN<br />
            <span style={{ color: "#f87171", textShadow: "0 0 50px rgba(220,38,38,0.5)" }}>VEREIN.</span><br />
            DEINE<br />
      ...
      <section style={{ padding: "96px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ marginBottom: 56 }}>
            <div style={{ fontSize: 12, color: "#f87171", fontWeight: 700, letterSpacing: "0.15em", marginBottom: 12 }}>// UNSERE SPORTARTEN</div>
            <h2 style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 900, letterSpacing: "-0.03em", textTransform: "uppercase" }}>
              SPORT FÜR<br /><span style={{ WebkitTextStroke: "2px rgba(255,255,255,0.25)", color: "transparent" }}>JEDEN.</span>
            </h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 16 }}>
            {sports.map((sport) => (
              <div key={sport.name}
                ...
                <div style={{ position: "absolute", inset: 0, background: "radial-gradient(circle at top right, rgba(220,38,38,0.08) 0%, transparent 60%)", pointerEvents: "none" }}></div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <div style={{ width: 8, height: 8, borderRadius: "50%", backgroundColor: "#dc2626", boxShadow: "0 0 8px #dc2626" }}></div>
                  <span style={{ fontSize: 13, color: "#f87171", fontWeight: 700 }}>{sport.members} Mitglieder</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section style={{ padding: "96px 24px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 56, flexWrap: "wrap", gap: 16 }}>
            <div>
              <div style={{ fontSize: 12, color: "#f87171", fontWeight: 700, letterSpacing: "0.15em", marginBottom: 12 }}>// AKTUELLES</div>
              <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 900, letterSpacing: "-0.03em", textTransform: "uppercase" }}>NEWS &amp; EVENTS</h2>
            </div>
            <a href="#" style={{ fontSize: 13, color: "#f87171", fontWeight: 700, textDecoration: "none", letterSpacing: "0.05em" }}>ALLE NACHRICHTEN →</a>
          </div>
          <div style={{ display: "grid", gap: 2 }}>
            {news.map((item, i) => (
              <div key={i} style={{ display: "grid", gridTemplateColumns: "140px 1fr auto", alignItems: "center", gap: 24, padding: "28px 32px", backgroundColor: i === 0 ? "rgba(220,38,38,0.06)" : "transparent", border: i === 0 ? "1px solid rgba(220,38,38,0.2)" : "1px solid transparent", borderRadius: 8, cursor: "pointer", transition: "background-color 0.2s" }}
                className="news-row-a">
                <div style={{ fontSize: 12, color: "#64748b", fontFamily: "system-ui, sans-serif", fontWeight: 600 }}>{item.date}</div>
                <div>
                  <div style={{ fontSize: 11, color: "#f87171", fontWeight: 700, letterSpacing: "0.1em", marginBottom: 6 }}>{item.category}</div>
      ...
      <section style={{ padding: "0 24px 96px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ background: "linear-gradient(135deg, #991b1b 0%, #dc2626 50%, #ef4444 100%)", borderRadius: 20, padding: "80px 48px", textAlign: "center", position: "relative", overflow: "hidden" }}>
            <div style={{ position: "absolute", top: -40, right: -40, width: 200, height: 200, borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.06)" }}></div>
            <div style={{ position: "absolute", bottom: -60, left: -30, width: 280, height: 280, borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.04)" }}></div>
            <div style={{ position: "relative", zIndex: 10 }}>
              <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.15em", color: "rgba(255,255,255,0.5)", marginBottom: 16 }}>// MITGLIEDSCHAFT</div>
              <h2 style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 900, color: "#fff", letterSpacing: "-0.03em", textTransform: "uppercase", marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
                ...
                <a href="#" style={{ backgroundColor: "rgba(255,255,255,0.15)", color: "#fff", fontWeight: 700, fontSize: 15, padding: "16px 32px", borderRadius: 8, textDecoration: "none" }}>MEHR ERFAHREN</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <style>{`
        .sport-card-a:hover { border-color: rgba(220,38,38,0.45) !important; box-shadow: 0 0 32px rgba(220,38,38,0.18); transform: translateY(-2px); }
