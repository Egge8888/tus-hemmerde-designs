const designs = [
  ...
  },
  {
    ...
    label: "Design 2",
    name: "Dark Classic",
    tagline: "Dunkel · Rot-Akzent · Strukturiert",
  ...
  },
  {
    ...
    tagline: "Warm · Serif · Einladend",
    description: "Warmes Off-White, Serif-Typografie und Fotocollage — persönlich und einladend wie ein Schwarzes Brett.",
  ...
  // ── 6–15: Weitere Entwürfe ───────────────────────────────────────────────
  {
    href: "/design-m.html",
    label: "Design 6",
    name: "Swiss Rationalism",
    tagline: "Minimalist · Raster · Präzise",
    description: "Roter Balken oben, strenge Typografie, Grid-Perfektion. Schweizer Designschule trifft Vereinssport.",
  ...
  },
  {
    ...
    description: "Schwarze Nav, krachend rotes Hero, harter Offset-Shadow-Stil. Großbuchstaben, keine Rundungen — roh wie ein Stadion.",
  ...
  },
  {
    ...
    description: "Weiße Transparenz-Elemente, Glaseffekte und rote Akzente auf hellem Hintergrund. Leicht und elegant.",
